...
return (
    <div id="about">
        ...
        <div id="aboutWrapper">
            ...
            <div id="aboutText">
                <p>Depuis 1993 un Doua De Jazz c’est LE festival de jazz étudiant ! Unique en France, il s’agit d’un festival annuel ayant lieu courant octobre à Lyon et Villeurbanne. Sur un peu plus d’une semaine sont organisés de nombreux concerts de jazz, et de tous les styles qui en découlent : house, funk, soul, hip hop ou encore afrobeat ! Le festival c’est également des masterclass, jam sessions et expositions, le tout organisé par une équipe d’étudiants bénévoles dévoués et passionnés.</p>
                ...
                <p>En suivant ses engagements au fil des années, le Doua de Jazz a ainsi réussi à regrouper un véritable public grandissant, qu'il soit passionné ou simplement curieux c:</p>
            </div>
            <hr/>
